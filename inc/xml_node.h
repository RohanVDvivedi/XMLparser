...
dstring* get_xml_attribute_from_xml_node(xml_node* xml_node_p, const dstring* key);
int exists_xml_attribute_from_xml_node(xml_node* xml_node_p, const dstring* key);
